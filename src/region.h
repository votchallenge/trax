...
__TRAX_EXPORT void region_get_mask(const region_container* r, char* mask, int width, int height);

__TRAX_EXPORT void region_get_mask_offset(const region_container* r, char* mask, int x, int y, int width, int height);
