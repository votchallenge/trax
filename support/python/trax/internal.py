...
# clang2py -l libtrax.so --debug ../include/trax.h
...
_libraries = {}
_libraries['libtrax.so'] = ctypes.CDLL('./libtrax.so')
...
trax_no_log = (struct_trax_logging).in_dll(_libraries['libtrax.so'], 'trax_no_log')
trax_no_bounds = (struct_trax_bounds).in_dll(_libraries['libtrax.so'], 'trax_no_bounds')

trax_version = _libraries['libtrax.so'].trax_version
trax_version.restype = ctypes.c_char_p
trax_version.argtypes = []

trax_metadata_create = _libraries['libtrax.so'].trax_metadata_create
...
trax_client_setup_socket = _libraries['libtrax.so'].trax_client_setup_socket
...
trax_client_wait = _libraries['libtrax.so'].trax_client_wait
...
trax_client_initialize = _libraries['libtrax.so'].trax_client_initialize
...
trax_client_frame = _libraries['libtrax.so'].trax_client_frame
...
trax_server_setup = _libraries['libtrax.so'].trax_server_setup
...
trax_server_setup_file = _libraries['libtrax.so'].trax_server_setup_file
...
trax_server_wait = _libraries['libtrax.so'].trax_server_wait
...
trax_server_reply = _libraries['libtrax.so'].trax_server_reply
...
trax_get_parameter = _libraries['libtrax.so'].trax_get_parameter
...
trax_image_create_buffer = _libraries['libtrax.so'].trax_image_create_buffer
...
trax_image_write_memory_row = _libraries['libtrax.so'].trax_image_write_memory_row
...
trax_image_get_memory_row = _libraries['libtrax.so'].trax_image_get_memory_row
...
trax_image_get_buffer = _libraries['libtrax.so'].trax_image_get_buffer
...
trax_region_set_rectangle = _libraries['libtrax.so'].trax_region_set_rectangle
...
trax_region_get_rectangle = _libraries['libtrax.so'].trax_region_get_rectangle
...
trax_region_create_polygon = _libraries['libtrax.so'].trax_region_create_polygon
trax_region_create_polygon.restype = POINTER_T(None)
trax_region_create_polygon.argtypes = [ctypes.c_int32]

trax_region_set_polygon_point = _libraries['libtrax.so'].trax_region_set_polygon_point
...
trax_region_get_polygon_point = _libraries['libtrax.so'].trax_region_get_polygon_point
...
trax_properties_set_int = _libraries['libtrax.so'].trax_properties_set_int
...
trax_properties_set_float = _libraries['libtrax.so'].trax_properties_set_float
...
trax_properties_get = _libraries['libtrax.so'].trax_properties_get
trax_properties_get.restype = ctypes.c_char_p
trax_properties_get.argtypes = [POINTER_T(struct_trax_properties), ctypes.c_char_p]

trax_properties_get_int = _libraries['libtrax.so'].trax_properties_get_int
...
trax_properties_get_float = _libraries['libtrax.so'].trax_properties_get_float
...
trax_properties_count = _libraries['libtrax.so'].trax_properties_count
trax_properties_count.restype = ctypes.c_int32
trax_properties_count.argtypes = [POINTER_T(struct_trax_properties)]

trax_properties_enumerate = _libraries['libtrax.so'].trax_properties_enumerate
